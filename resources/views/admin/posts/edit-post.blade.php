<x-admin-master>
    ...
    @section("content")
      ...
      <div class="posts">
        ...
        <form method="post" class="form" action="{{ route('posts.update' , $post->id ) }}" enctype="multipart/form-data">
        @csrf 
         @method("PUT")
        ...
        <div class="post-body mb-5">
          <div class="form-group">
            ...
            <textarea class="form-control my-editor" name="body" id="mytextarea" cols="30"  rows="20"> {{ $post->body }}" </textarea>
